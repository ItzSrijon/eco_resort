...
public class ViewIncidentsController {
    ...
    @FXML private TableColumn<Incident, String> incidentIdTC;
    @FXML private TableColumn<Incident, String> incidentTitleTC;
    @FXML private TableColumn<Incident, String> incidentTypeTC;
    @FXML private TableColumn<Incident, LocalDate> reportingDateTC;
    @FXML private TableColumn<Incident, String> statusTC;
    @FXML private Label messageLabel;

    private final ObservableList<Incident> incidentList =
    ...
    // Event-2 & Event-3: Retrieve incident history
    private void loadIncidents() {
        ...
        if (!file.exists()) {
            messageLabel.setText("No incident history found.");
            return;
        }
    ...
    // Event-8: Return to Security Dashboard
    @FXML
